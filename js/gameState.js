...
class gameState extends Phaser.Scene {
    ...
    preload() { //carga los assets en memoria
        ...
        this.load.spritesheet('player', rutaSprites + 'BillySprites/CharacterSpritesheet.png', { frameWidth: 72, frameHeight: 46 });
        this.load.audio('bgMusic', 'assets/sounds/music/mission1.ogg');
        this.load.audio('punch', 'assets/sounds/pucnh.ogg');
    }
